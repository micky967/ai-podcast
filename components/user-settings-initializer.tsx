...
export function UserSettingsInitializer() {
  ...
  useEffect(() => {
    ...
    console.log(
      "[UserSettingsInitializer] Initializing user settings for:",
      userId
    );
    ...
    initializeUserSettings({ userId })
      .then((result) => {
        console.log(
          "[UserSettingsInitializer] Successfully initialized user settings. ID:",
          result
        );
      })
      .catch((error) => {
        ...
        console.error(
          "[UserSettingsInitializer] Failed to initialize user settings:",
          error
        );
